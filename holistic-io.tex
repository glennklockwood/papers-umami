...
\hline
HACC-IO & GLEAN; file-per-process; write & 1,024 & 16,384 & ~2.4 TiB & 12.6 & 198 \\
\hline
HACC-IO & GLEAN; file-per-process; read & 1,024 & 16,384 & ~2.4 TiB & 14.9 & 172 \\
\hline
VPIC-IO & pHDF5; shared file; write & 1,024 & 16,384 & ~512 GiB & 9.6 & 53.4 \\
\hline
BDCATS-IO & pHDF5; shared file; read & 1,024 & 16,384 & ~80 MiB & .01 & 16.5 \\
\hline
\end{tabular}
\caption{Caption.}
...
\textcolor{red}{NOTES:}
\begin{itemize}
    \item \textcolor{red}{I have scaled back HACC-IO to agg. size of 1.5 TiB to keep it closer to 2 minutes for all future runs.}
    \item \textcolor{red}{I have scaled up VPIC-IO to agg. size of 1.0 TiB to get it closer to 2 minutes for future runs.}
    \item \textcolor{red}{Why is the BDCATS-IO workload so small?}
\end{itemize}
