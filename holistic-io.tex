...
Figure \ref{fig:coverage-factor-distribution} demonstrates the distribution of
coverage factors across all experiments run and confirms that the vast majority
of tests ($> 85\%$) had a high coverage factor ($ CF > 0.90 $).  Despite this, 

\begin{figure}[t]
\centering
\includegraphics[width=1.0\columnwidth]{figs/coverage-factor-histogram.png}
\caption{Frequency of coverage factors observed across all experiments}
