...
For example, open repo for the benchmark configs and cron jobs we used, so
that others can replicate the same workload drivers.  We could also publish
anonymized data used in the study.}
