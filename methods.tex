...
The set of tools provided is not intended to be comprehensive or final -- new data can be incorporated into TOKIO by defining mechanisms for collecting and extracting relevant data from a specific instrumentation source.
