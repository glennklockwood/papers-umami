...
\todo{do we combine the system descriptions (above) with the benchmarks (below)?  right now they show signs of overlap}
...
\subsection{Edison benchmark configuration} \label{sec:platforms/mirabenchmarks}
