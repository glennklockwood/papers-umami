...
\begin{itemize}
\item A framework for holistic instrumentation of I/O subsystems that is
generalizable across platforms 
\item A demonstration of the framework on NERSC's Edison system and ALCF's Mira system
\item Case studies highlighting I/O performance insights gleaned from a
multiplatform, month-long automated I/O benchmarking effort
\end{itemize}
