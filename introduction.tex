...
Different I/O patterns and read/write workloads expose different degrees of performance variation on different parallel file system architectures. \todo{the high-impact finding is that variation is a function of I/O motif, file system architecture, AND file system climate (as evidenced by scratch3 being different from scratch2}
