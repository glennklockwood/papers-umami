...
\newtext{These case studies were dervied from jobs run on Mira and Edison, but UMAMI draws data from any component-level monitoring that a system may run at an HPC center.}
