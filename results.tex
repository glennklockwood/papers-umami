...
\begin{figure}[t]
    ...
    \caption{TOKIO-UMAMI demonstrating the climate surrounding VPIC-IO write workloads on Mira compared to a most recent run, which showed highly unusual weather in the form of an excess of readdir(3) calls.
...
\todo{tighten this up with respect to readdir(3) and make sure the discussion is consistent with earlier sections} The TOKIO framework was also able to identify longer-term performance issues which progressively degraded write performance.
