...
We present three case studies that highlight the importance of analyzing application I/O performance in context with both contemporaneous and historical component metrics, and we provide new insights into the factors affecting I/O performance and how to analyze them.
%\todo{Something about turning this into a production tool.}
\newtext{By demonstrating the generality of our approach with these insights from two different HPC centers, we lay the groundwork for a production-grade framework for holistic I/O analysis.}
