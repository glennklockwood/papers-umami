...
In this work we present a framework for holistic I/O characterization that combines I/O instrumentation data from multiple sources to obtain insights that were previously unobtainable.
